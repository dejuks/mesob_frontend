  ...
  return (
      <main className="min-h-screen bg-white text-slate-900">
        ...
        <section className="relative overflow-hidden bg-slate-50 text-slate-900">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(14,165,233,0.15),transparent_30%),radial-gradient(circle_at_80%_10%,rgba(56,189,248,0.15),transparent_28%)]" />
          <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
            <div>
              <Button
                  asChild
                  variant="ghost"
                  className="mb-8 h-auto rounded-full bg-white/80 px-4 py-2 text-sm font-bold backdrop-blur hover:bg-white"
              >
              ...
              <Badge className="mb-4 bg-sky-100 px-4 py-2 text-sm font-bold text-sky-700 hover:bg-sky-200 border-0">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <Button asChild size="lg" className="rounded-xl bg-sky-500 font-black text-white shadow-xl hover:bg-sky-600">
                  <Link href="/services">
                    View Digital Services <ArrowRight className="ml-2 h-5 w-5" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="secondary" className="rounded-xl bg-white font-black text-slate-900 shadow-xl hover:bg-slate-100">
                  <Link href="/about">About MESOB</Link>
                </Button>
              </div>
            </div>

            <Card className="rounded-[2rem] border border-slate-200 bg-white/80 p-5 shadow-2xl backdrop-blur">
              <Card className="rounded-[1.5rem] border-0 bg-white p-5 shadow-none">
                <CardContent className="p-0">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                      <Landmark className="mb-4 h-8 w-8 text-sky-500" />
                      <div className="text-4xl font-black text-slate-950">1</div>
                      <p className="mt-1 text-sm font-bold text-slate-600">City Administration</p>
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                      <Building2 className="mb-4 h-8 w-8 text-sky-500" />
                      <div className="text-4xl font-black text-slate-950">{providers.length}+</div>
                      <p className="mt-1 text-sm font-bold text-slate-600">Service Providers</p>
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                      <Users className="mb-4 h-8 w-8 text-sky-500" />
                      <div className="text-4xl font-black text-slate-950">All</div>
                      <p className="mt-1 text-sm font-bold text-slate-600">Citizens & Businesses</p>
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-sm">
                      <ShieldCheck className="mb-4 h-8 w-8 text-sky-500" />
                      <div className="text-4xl font-black text-slate-950">24/7</div>
                      <p className="mt-1 text-sm font-bold text-slate-600">Digital Access</p>
                    </div>
                  </div>
                  <div className="mt-5 rounded-2xl bg-gradient-to-r from-slate-900 to-sky-500 p-5 text-white">
                    <p className="text-sm font-bold uppercase tracking-wider text-sky-100">Service Ownership</p>
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            <Card className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              <CardContent className="p-0">
                ...
                <h2 className="text-2xl font-black text-slate-950">Official Providers</h2>
            ...
            <Card className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              <CardContent className="p-0">
                ...
                <h2 className="text-2xl font-black text-slate-950">Digital Workflow</h2>
            ...
            <Card className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              <CardContent className="p-0">
                ...
                <h2 className="text-2xl font-black text-slate-950">Better Governance</h2>
        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-7xl px-4 md:px-8">
            <div className="mb-10 max-w-3xl">
              <p className="text-sm font-black uppercase tracking-widest text-sky-500">Provider Directory</p>
              <h2 className="mt-3 text-3xl font-black text-slate-950 md:text-4xl">Government offices connected to Adama MESOB eService</h2>
            </div>

            <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {providers.map((provider, index) => (
                  <Card key={provider.id} className="group rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm transition hover:-translate-y-1 hover:bg-white hover:shadow-xl">
                    <CardContent className="p-0">
                      ...
                      <h3 className="text-lg font-black leading-7 text-slate-950">{provider.name}</h3>
        ...
        <section className="bg-slate-900 py-16 text-white">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 md:px-8 lg:grid-cols-[0.8fr_1.2fr]">
            <div>
              <p className="text-sm font-black uppercase tracking-widest text-sky-400">Why providers matter</p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 md:px-8">
          <Card className="grid gap-8 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-xl md:p-10 lg:grid-cols-3">
            <CardContent className="p-0 lg:col-span-2">
              <p className="text-sm font-black uppercase tracking-widest text-sky-500">Adama MESOB Service Center</p>
              <h2 className="mt-3 text-3xl font-black text-slate-950 md:text-4xl">A coordinated provider network for faster public service delivery.</h2>
            ...
            <Card className="rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-sm">
              <CardContent className="space-y-4 p-0">
                ...
                <h3 className="text-xl font-black text-slate-950">Need Support?</h3>
                ...
                <Button className="w-full rounded-xl bg-sky-500 font-bold text-white hover:bg-sky-600">
                  Contact Support
                </Button>
              </CardContent>
            </Card>
